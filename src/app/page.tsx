...
export default function HomePage() {
    ...
    return (
        <main className="container mx-auto px-4 py-8 md:py-16">
            ...
            <header className="relative mb-16 overflow-hidden rounded-3xl p-8 md:p-16 lg:p-20 bg-gray-900 text-white shadow-2xl border border-gray-700">
                ...
                <div className="relative z-10 text-center max-w-4xl mx-auto">
                    ...
                    {/* HIZLI ANFAHRT + PUAN */}
                    <div className="inline-flex items-center gap-4 text-sm font-medium mb-6 bg-yellow-400/90 backdrop-blur-sm rounded-full p-2 pr-4 text-gray-900">
                        <span className="bg-white px-3 py-1 rounded-full flex items-center gap-2 font-black">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black mb-6 leading-snug tracking-tight">
                    ...
                    >
                        <PhoneIcon className="h-6 w-6 mr-3" /> Jetzt Sofort Anrufen: {defaultTelefon}
                    </a>

                    {/* Fiyat ve Hızlı Bilgi */}
                    <div className="flex flex-wrap justify-center gap-6 mt-8">
                        <span className="text-yellow-400 font-bold text-lg border-b-2 border-red-600">
